#!/bin/bash
# Check incoming data of last 24h and send report.
...
report=$(sudo-linux python3 /home/ubuntu/radar-docker/lib/radar-data-monitor.py /mnt/hdfs-extract/UKLFR-Epi2 /mnt/hdfs-extract/KCL-Epi2 --only-active)
echo -e "$report" | grep -e "-->" >> "/home/ubuntu/radar-docker/logs/radar-data-monitor/radar-data-monitor-$(date +%Gw%V).log"
enddt="$(date -Iseconds)"
